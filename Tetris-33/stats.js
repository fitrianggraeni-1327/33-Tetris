/**
 * File: stats.js
 * Purpose: Contains the logic for performance tracking, game statistics,
 *          and other auxiliary functions used in the Tetris game.
 * 
 * This file provides helper methods to:
 * - Initialize and display statistics (e.g., FPS).
 * - Manage game scoring and performance updates.
 * - Interface with the HTML structure to update DOM elements dynamically.
 * 
 * Author: [Fitri]
 * Date: [dec,24]
 */
